...
import org.apache.flink.runtime.webmonitor.handlers.utils.RedJarHandlerUtils;
...
public class RedJarRunHandler
    ...
    protected CompletableFuture<JarRunResponseBody> handleRequest(
        ...
        final RedJarHandlerUtils.RedJarHandlerContext context =
                RedJarHandlerUtils.RedJarHandlerContext.fromRequest(request, jarDir, log);
                        ...
                        (jobGraph, blobServerPort) -> {
                            ...
                            try {
                                ClientUtils.extractAndUploadJobGraphFiles(
                                        jobGraph, () -> new BlobClient(address, configuration));
        ...
        return jobSubmissionFuture.thenCombine(
                jarUploadFuture, (ack, jobGraph) -> new JarRunResponseBody(jobGraph.getJobID()));
    }
    ...
    private CompletableFuture<JobGraph> getJobGraphAsync(
            RedJarHandlerUtils.RedJarHandlerContext context,
            final SavepointRestoreSettings savepointRestoreSettings) {
