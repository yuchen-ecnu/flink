...
public class RedJarRunHeaders
        implements SqlGatewayMessageHeaders<JarRunRequestBody, JarRunResponseBody, JarRunMessageParameters> {

    private static final RedJarRunHeaders INSTANCE = new RedJarRunHeaders();

    private RedJarRunHeaders() {}
    ...
    public String getTargetRestEndpointURL() {
        return "/red-jars/:" + JarIdPathParameter.KEY + "/run";
    }

    public static RedJarRunHeaders getInstance() {
        return INSTANCE;
    }
