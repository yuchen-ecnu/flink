...
public class JobDetailHandlerTest {
    ...
    private final String expectedJsonStreamGraph =
            "{\"nodes\":[{\"id\":\"1\",\"parallelism\":1,\"operator\":\"Source: Sequence Source\",\"description\":\"Source: Sequence Source\",\"inputs\":[]},{\"id\":\"2\",\"parallelism\":1,\"operator\":\"Sink: Print to Std. Out\",\"description\":\"Sink: Print to Std. Out\",\"inputs\":[{\"num\":0,\"id\":\"1\",\"ship_strategy\":\"FORWARD\",\"exchange\":\"UNDEFINED\"}]}]}";
    ...
    void setUp(@TempDir Path tempDir) throws HandlerRequestException {
        ...
        archivedExecutionGraph =
                new ArchivedExecutionGraphBuilder()
                        .setJsonStreamGraph(new JsonStreamGraph(expectedJsonStreamGraph, 2))
    ...
    @Test
    void testGetJobDetailsWithJsonStreamGraph() throws RestHandlerException {
        JobDetailsInfo jobDetailsInfo =
                jobDetailsHandler.handleRequest(handlerRequest, archivedExecutionGraph);
        assertThat(jobDetailsInfo.getJsonStreamGraphPlan())
                .isEqualTo(new JobPlanInfo.RawJson(expectedJsonStreamGraph).toString());
        assertThat(jobDetailsInfo.getJobVerticesPerState().get(ExecutionState.PENDING))
                .isEqualTo(2);
    }
}
