...
public class CustomBuffer implements Buffer {
    ...
    public CustomBuffer(DataType dataType, int length, boolean isCompressed) {
        this.dataType = checkNotNull(dataType);
        this.length = length;
        this.isCompressed = isCompressed;
    }

    public CustomBuffer(BufferHeader header) {
    ...
    public void addPartialBuffer(Buffer buffer) {
        if (buffer.getDataType() != dataType) {
            buffer.setDataType(dataType);
        }

        if (buffer.isCompressed() != isCompressed) {
