...
public class StreamGraphSubmitHeaders
        implements RuntimeMessageHeaders<
                JobSubmitRequestBody, JobSubmitResponseBody, EmptyMessageParameters> {

    private static final String URL = "/jobs";
    private static final StreamGraphSubmitHeaders INSTANCE = new StreamGraphSubmitHeaders();

    private StreamGraphSubmitHeaders() {}
    ...
    public static StreamGraphSubmitHeaders getInstance() {
        return INSTANCE;
    }
